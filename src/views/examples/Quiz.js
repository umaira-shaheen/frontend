...
function AddQuiz(e)
  {
    ...
    axios({    //AddUser API Calling
      ...
      data:{quiz_title:quiz_title, start_date:start_date, end_date:end_date, questions:questions},
    })
    .then(res=>{
      if(res.data == "success")
      {
  ...
  function EditQuiz(e)
  {
    ...
    axios({     //edit Course on the base of id API Calling
      ...
      data:{id:id, quiz_title:quiz_title, start_date:start_date, end_date:end_date, questions:questions},
    })
    .then(res=>{
      if(res.data == "success")
      {
