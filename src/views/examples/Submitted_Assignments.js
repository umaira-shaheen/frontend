...
const Submitted_Assignments = (args) => {
    ...
    function FindAssignment(id, student_id, Firstname, Lastname) {
            ...
            <Container className="mt--7" fluid>
                ...
                <Modal isOpen={modal} toggle={toggle} {...args} size='lg'>
                    <Form role="form" onSubmit={UploadMarks}>
                        <ModalHeader toggle={toggle}>Upload Marks</ModalHeader>
                        <ModalBody>
                                                                ...
                                                                <tr key={`${index}-${idx}`}>
                                                                    ...
                                                                    {row.students[idx].marks_obtained !== "-1" ? (
                                                                        ...
                                                                        <Button
                                                                            color="primary"
                                                                            size="sm"
                                                                            onClick={() => { FindAssignment(row._doc._id, submittedBy, row.students[idx].student_Firstname, row.students[idx].student_Lastname) }}
